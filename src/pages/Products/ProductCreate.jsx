...
const ProductCreate = () => {
  ...
  const [variants, setVariants] = useState([]); // [{ material, color, price, stock }]
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post("/Products", {
        ...
        // Có biến thể thì KHÔNG gửi material/color gốc nữa (mỗi biến thể tự có riêng) —
        // để null cho rõ ràng, tránh Admin tưởng đây vẫn là chất liệu/màu bán thật.
      ...
      setError(err.response?.data?.message || "Lỗi khi thêm sản phẩm! Kiểm tra lại backend.");
    } finally {
      setSaving(false);
    }
  };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-section">
            ...
            <div className="form-grid">
              ...
              {/* Chất liệu/Màu sắc gốc CHỈ hiện khi sản phẩm KHÔNG có biến thể — có biến
                  thể thì mỗi biến thể tự chọn Chất liệu/Màu riêng ở mục bên dưới. */}
              {!hasVariants && (
                <>
                  <div className="form-group">
          ...
          <div className="form-section">
            ...
            <p className="settings-field-hint" style={{ marginBottom: 12 }}>
              Mỗi biến thể là 1 tổ hợp Chất liệu + Màu sắc, có giá và tồn kho riêng. Tổng
              tồn kho các biến thể không được vượt quá "Tồn kho tổng" ở trên. Để trống
              hoàn toàn nếu sản phẩm chỉ bán 1 loại duy nhất.
            </p>
